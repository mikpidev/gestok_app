    ...
    <div class="container-fluid mt-4">
        ...
        <tbody>
            @forelse($productTypes as $productType)
                <tr>
                    <td><a href="{{ route('stores.product_types.show', [$store->id, $productType->id]) }}">{{ $productType->name }}</a></td>
                    ...
                    <div class="d-flex justify-content-center gap-1">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('stores.product_types.show', [$store->id, $productType->id]) }}">Ver detalles</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <form action="{{ route('stores.product_types.destroy', [$store->id, $productType->id]) }}" method="POST" onsubmit="return confirm('¿Seguro que deseas eliminar este producto?');">
                                        @csrf
                                        @method('DELETE')
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center">No hay productos disponibles en esta tienda.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
